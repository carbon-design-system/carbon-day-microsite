      ...
      <Column sm={4} md={8} lg={{ span: 14, offset: 1 }}>
        ...
        <div className="home-page__sidebar-content">
          ...
          <p className="home-page__subheading">
            Let's build the future of consumable software, together<br/><br/>
            Raleigh, NC
          </p>
        </div>
              ...
              <TabPanels>
                <TabPanel className="agenda-tab-panel">
                  <div className="agenda-section">
                    ...
                    <div className="agenda-item">
                      <div className="agenda-item__time">12:00pm–12:15pm</div>
                      <div className="agenda-item__content">
                    ...
                    <div className="agenda-item">
                      <div className="agenda-item__time">12:15pm–1:00pm</div>
                      <div className="agenda-item__content">
                    ...
                    <div className="agenda-item">
                      <div className="agenda-item__time">2:00pm–4:00pm</div>
                      <div className="agenda-item__content">
                        ...
                        <p className="agenda-item__description" style={{ fontStyle: 'italic', marginTop: '0.5rem' }}>Featuring Figma's Johann Collins and TJ Guyton</p>
                      </div>
                    </div>
                  </div>
                </TabPanel>
                  ...
                  <div className="survey-section">
                    <Grid condensed>
                      <Column sm={4} md={8} lg={16}>
                        ...
                        <Link href="https://your.feedback.ibm.com/jfe/form/SV_80WahkmOAJBICfc" target="_blank" rel="noopener noreferrer" className="survey-section__link">Take the survey</Link>
                      </Column>
                    </Grid>
                  </div>
                </TabPanel>
